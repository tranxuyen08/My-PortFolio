...
import realProfile from "../assets/img/beauty_1657774854558.webp"
import hoverProfile from "../assets/img/beauty_1658490949943.webp";
    ...
    <>
      ...
      <Container fluid className="home-wrapper">
        <div className="home-left animate__animated animate__fadeInLeft">
          ...
          <h2>
            <span className="name-hover">Xuyen</span>
            <br />
            <span className="name-hover">Tran Ngoc</span>
          </h2>
